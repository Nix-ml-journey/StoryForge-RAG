...
Usage (server must be running in another terminal: python main.py):
    py scripts/test_generation.py              # run all tests
    py scripts/test_generation.py --test 1     # run a single test by number
    py scripts/test_generation.py --debug      # show full response including grounded facts
